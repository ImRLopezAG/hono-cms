import type { HealthStatus, LocaleVariant, TranslationStore } from "@hono-cms/core";
...
/**
 * Creates a Drizzle-backed {@link TranslationStore}. Two dialects are
 * supported: `sqlite` (`drizzle-orm/sqlite-core`) and `postgres`
 * (`drizzle-orm/pg-core`).
 *
