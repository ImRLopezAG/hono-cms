/**
 * Defensive validation for storage object keys. Mirrors the core helper of the
 * same name — keys are user-influenced (filenames are part of the key after
 * `media/<uuid>-`), so we reject anything that could escape the bucket prefix.
 */
