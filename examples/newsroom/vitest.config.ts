...
export default defineConfig({
  resolve: {
    alias: {
      ...
      "@hono-cms/content-cache": resolve(root, "packages/content-cache/src/index.ts"),
      "@hono-cms/webhooks": resolve(root, "packages/webhooks/src/index.ts"),
      "@hono-cms/drafts": resolve(root, "packages/drafts/src/index.ts"),
      "@hono-cms/media": resolve(root, "packages/media/src/index.ts")
    }
  },
  test: {
    include: ["src/**/*.test.ts"]
